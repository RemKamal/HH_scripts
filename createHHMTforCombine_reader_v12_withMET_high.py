...
debugMode = True # for printing with bazinga                                 
def bazinga (mes):
    if debugMode:
        print mes
...
addNonBJets_if_new_minitrees = True

newBGravOnly = False
newRadionOnly = False
doAllSamples = True

#BGravOrRadionDirectory = "BulkGraviton" if "BulkGraviton" in glob.glob("Glu*ToHHTo2B2*root")[0] else "Radion" if "Radion" in glob.glob("Glu*ToHHTo2B2*root")[0] else None

BGravOrRadionDirectory = None
if "BulkGraviton" in glob.glob("Glu*ToHHTo2B2*root")[0]:
    BGravOrRadionDirectory = "BulkGraviton"
    newBGravOnly = True
elif "Radion" in glob.glob("Glu*ToHHTo2B2*root")[0]:
    BGravOrRadionDirectory = "Radion"
    newRadionOnly = True
else:
    BGravOrRadionDirectory = None


if BGravOrRadionDirectory == None:
    print 'check BGravOrRadionDirectory....exiting...'
    sys.exit(1)
...
if args_are_given:
    ...
    if doMETcut:
        if len(sys.argv) > 6 and 'met' in sys.argv[6]:
            METcut_tmp =  (sys.argv[6]).strip('met')
            if METcut_tmp.isdigit():
                METcut = int (METcut_tmp)
                if METcut in [40, 75, 100]:
                    print 'METcut is ', METcut
                    pass
                else:
                    print 'wrong METcut, please use one from [40, 75, 100], exiting.'
                    sys.exit(1)
            else:
                print 'please check METcut value: [40, 75, 100]'
                sys.exit(1)
        else:
            print 'please specify METcut value: [40, 65, 100]'
            sys.exit(1)
...
if newBGravOnly:
#if newRadionOnly:
    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")


if newRadionOnly:
    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_1000_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-1000_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_260_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-260_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_270_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-270_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")
    
    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_300_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-300_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_350_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-350_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_400_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-400_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_450_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-450_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_600_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-600_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_650_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-650_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_900_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2VTo2L2Nu_M-900_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_1000_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-1000_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_260_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-260_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_270_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-270_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_300_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-300_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_350_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-350_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_400_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-400_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_450_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-450_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_500_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-500_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_550_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-550_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_600_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-600_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_650_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-650_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_750_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-750_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_800_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-800_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_900_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2J_M-900_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_1000_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-1000_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_260_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-260_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_270_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-270_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_300_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-300_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_350_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-350_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_400_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-400_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_450_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-450_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_600_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-600_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_650_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-650_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

    zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_900_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 = ROOT.TFile(dirWithMCSamples + "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-900_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1_minitree.root")

# ====================================================================================
if "Bulk" in BGravOrRadionDirectory:
    ...
    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_1000_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-1000_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_260_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-260_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_270_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-270_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_300_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-300_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_350_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-350_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_400_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-400_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_450_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-450_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_600_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-600_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_650_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-650_narrow_13TeV-madgraph_minitree.root")

    ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_900_narrow_13TeV_madgraph_HWW = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-900_narrow_13TeV-madgraph_minitree.root")

# all files to include, INDENT left!
...
if newBGravOnly:
    dict_new_BGrav = { #newBGravOnly #newRadionOnly
#dictOfFiles = {
    
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToBulkGravitonToHHTo2B2VTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1"
        }

if newRadionOnly:
    dict_new_Radion = {
    
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_1000_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-1000_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_260_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-260_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
    
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_270_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-270_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_300_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-300_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_350_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-350_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_400_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-400_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_450_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-450_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_600_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-600_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",
        
        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_650_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-650_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        ww_sigInputFile_GluGluToRadionToHHTo2B2VTo2L2Nu_M_900_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2VTo2L2Nu_M-900_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_1000_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-1000_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_260_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-260_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_270_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-270_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_300_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-300_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_350_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-350_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_400_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-400_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_450_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-450_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_500_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-500_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_550_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-550_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_600_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-600_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_650_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-650_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_750_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-750_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_800_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-800_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        qq_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2J_M_900_narrow_13TeV_madgraph_v2__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2J_M-900_narrow_13TeV-madgraph-v2__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_1000_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-1000_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_250_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-250_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_260_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-260_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_270_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-270_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_300_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-300_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_350_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-350_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_400_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-400_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_450_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-450_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_500_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-500_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_550_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-550_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_600_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-600_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_650_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-650_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_700_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-700_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_750_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-750_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_800_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-800_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1",

        zz_sigInputFile_GluGluToRadionToHHTo2B2ZTo2L2Nu_M_900_narrow_13TeV_madgraph__RunIISummer16MAv2_PUMoriond17_80r2as_2016_TrancheIV_v6_v1 : "GluGluToRadionToHHTo2B2ZTo2L2Nu_M-900_narrow_13TeV-madgraph__RunIISummer16MAv2-PUMoriond17_80r2as_2016_TrancheIV_v6-v1"
        }

#========================

#dict_new_BGrav = { #newBGravOnly #newRadionOnly                                                                                                          
if "BulkGraviton" in BGravOrRadionDirectory:
    dictOfFiles_BulkGraviton = {  
...
if doAllSamples:
    if "Bulk" in BGravOrRadionDirectory:
        dictOfFiles.update(dict_new_BGrav)
        dictOfFiles.update(dictOfFiles_BulkGraviton)
    if "Radion" in BGravOrRadionDirectory:
        dictOfFiles.update(dict_new_Radion)
else:
    if newBGravOnly and not newRadionOnly:
        dictOfFiles = dict_new_BGrav
    elif not newBGravOnly and newRadionOnly:
        dictOfFiles = dict_new_Radion
    elif newBGravOnly and newRadionOnly:
        dictOfFiles = dict(dict_new_BGrav.items() + dict_new_Radion.items())
...
outDir = nameDir + massRegion + '_' + physRegion  + '_' + str(bdtCut) + '_met' + str(METcut) + '/'
...
if muonRun and eleRun:
#muonIsThere and eleIsThere:
    print 'keep only one type of data per time, exiting...'
    sys.exit(1)
#elif muonIsThere and not eleIsThere and 
elif muonRun and not eleRun:
    leptonType = "mm"
#elif eleIsThere and not muonIsThere and 
elif not muonRun and eleRun:
    leptonType = "ee"
else:
...
#    if 'CMS_pu' in systUnc:
 #       postf = 'CMS_puUp' if 'Up' in systUnc else 'CMS_puDown' if 'Down' in systUnc else None
    ...
    histos = {
        ...
        #'cutFlow{0}'.format(postf)       :ROOT.TH1F('cutFlow{0}'.format(postf), ';; Events', 11, 1, 12),
        #'cutFlowEff{0}'.format(postf)       :ROOT.TH1F('cutFlowEff{0}'.format(postf), ';; Efficiency, %', 11, 1, 12),

        'cutFlow{0}'.format(postf)       :ROOT.TH1F('cutFlow', ';; Events', 11, 1, 12),

        'njets{0}'.format(postf)     :ROOT.TH1F('njets{0}'.format(postf)      ,';Jet multiplicity; Events'                , 9, 0, 9),
        'nbjets{0}'.format(postf)     :ROOT.TH1F('nbjets{0}'.format(postf)      ,';Medium b-jet multiplicity; Events'                , 9, 0, 9),
        'nloosebjets{0}'.format(postf)     :ROOT.TH1F('nloosebjets{0}'.format(postf)      ,';Loose b-jet multiplicity; Events'                , 9, 0, 9),
        #see later outside of the dict
        #if addNonBJets_if_new_minitrees:
         #   'nnonbjets{0}'.format(postf)     :ROOT.TH1F('nnonbjets{0}'.format(postf)      ,';Non b-jet multiplicity; Events'                , 9, 0, 9),
    ...
    if addNonBJets_if_new_minitrees:
        histos['nnonbjets{0}'.format(postf)] = ROOT.TH1F('nnonbjets{0}'.format(postf)      ,';Non b-jet multiplicity; Events'                , 9, 0, 9)
    ...
    if (physRegion == "CRDYoneBin" or physRegion == "CRTToneBin"):
        ...
        histos['hhMt{0}'.format(postf)]  = ROOT.TH1F('hhMt{0}'.format(postf), ';#tilde{M_{T}}(HH) [GeV]; Events', (maxValue - minValue)/divideBy_forBinning, minValue, maxValue)
    ...
    for entry in sample.tree:
        histos['cutFlow{0}'.format(postf)].Fill(1,1) # no cut 
        if  leptonType == "ee" and entry.leppt0 <=25: continue
        histos['cutFlow{0}'.format(postf)].Fill(2,1) # ele 25 GeV cut 
        ...
        histos['cutFlow{0}'.format(postf)].Fill(3,1) # isolation cut
        if (1.4442 < abs(entry.lepeta0) < 1.566) or (1.4442 < abs(entry.lepeta1) <1.566): continue
        histos['cutFlow{0}'.format(postf)].Fill(4,1) # remove eta gap
...
#print 'modifierW is', modifierW
    ...
    # met_pt
        ...
        histos['cutFlow{0}'.format(postf)].Fill(5,1) # SR/CR cut

        if hmass1[0] < 20: continue #remove QCD
        # use 30 for the next iteration?!!!!
        histos['cutFlow{0}'.format(postf)].Fill(6,1) # Hbb 20 GeV cut
        ...
        histos['cutFlow{0}'.format(postf)].Fill(7,1) # DY low/high cut if needed
...
#        if doMETcut:
        ...
        histos['cutFlow{0}'.format(postf)].Fill(8,1) # met cut if any
        ...
        histos['cutFlow{0}'.format(postf)].Fill(9,1) # pre-BDT  
        if physRegion == 'SR':
            ...
            #print 'in CRxy'
            pass
        histos['cutFlow{0}'.format(postf)].Fill(10,1) # post BDT 
        ...
        histos['njets{0}'.format(postf)].Fill(entry.njets, eqLumi)
        histos['nbjets{0}'.format(postf)].Fill(entry.nbjets, eqLumi)
        histos['nloosebjets{0}'.format(postf)].Fill(entry.nloosebjets, eqLumi)
        if addNonBJets_if_new_minitrees:
            histos['nnonbjets{0}'.format(postf)].Fill(entry.nnonbjets, eqLumi)

        #histos['cutFlow{0}'.format(postf)].Fill(1, eqLumi)
        #histos['cutFlowEff{0}'.format(postf)].Fill(1, eqLumi)  
 ...
 #           hmass1[0] = Hbb_mass_binMin + 1
  #      if hmass1[0] > Hbb_mass_binMax:
   #        hmass1[0] = Hbb_mass_binMax - 1
        ...
        if 'ToHHTo2B2' in name :# or 'Hzz' in name:
            pp(sys.argv)
        ...
        histos['cutFlow{0}'.format(postf)].Fill(11,1) # final placeholder
        ievt += 1
#    if (ievt > 20000) : break
