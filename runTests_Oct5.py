...
date = 'oct5'
version = '_inpb_wBR'
jsons = ['toMakeDataCard_samples_1pb_bbZZ_muons_with_bbVV.json', 'toMakeDataCard_samples_1pb_bbZZ_electrons.json']
...
for typ in typeList:
    ...
    totalCmd = "nohup python runSimpleAn_v17_" + regionArgument  + ".py  -i samplesSept21  -j data/" + json + " -w analysis_" + date + "_total_" + typ + '_' + regionArgument + version + " -r " + typ + " -n 16 -t " + runTyp + " &> log_" + date + "_total_" + typ + '_' + regionArgument + version + ".txt&"
    print
