...
if useKeras:
    ...
    if doMultiClass:
        outputFile_multiClass_keras = ROOT.TFile("TMVAOutput_" + str(list_of_mass_points[-1]) + "_multiClass_keras_" + date + "{0}.root".format('_DG' if doDGtransform else ''), "RECREATE")
        factory = TMVA.Factory('TMVAMulticlass_' + str(list_of_mass_points[-1]) + '_keras', outputFile_multiClass_keras,
        ...
        outputFile_biClass_keras = ROOT.TFile("TMVAOutput_" + str(list_of_mass_points[-1]) + "_biClass_keras_" + date + "{0}.root".format('_DG' if doDGtransform else ''), "RECREATE")
        factory = TMVA.Factory("TMVAClassification_" + str(list_of_mass_points[-1]) + "_keras", outputFile_biClass_keras,
    ...
    if doMultiClass:
        ...
        outputFile_biClass = ROOT.TFile("TMVAOutput_" + str(list_of_mass_points[-1]) + "_biClass_" + date + "{0}.root".format('_DG' if doDGtransform else ''), "RECREATE")
        factory = TMVA.Factory("TMVAClassification" + str(list_of_mass_points[-1]), outputFile_biClass,
                               'V:!Silent:Color:DrawProgressBar:Transformations=I,{0}:AnalysisType=Classification'.format("D,G" if doDGtransform else ''))
