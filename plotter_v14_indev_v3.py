...
#////////////////////////
    ...
    def doStack(self, outDir,lumi,noScale=False,saveTeX=False, ratio=False, plotData = True, massPoint=0, bdtCut = 0.24, regionType = None, channel2run = None, doPostFit=False):
...
#        for key,value in ordDict.items():
 #           print(key, ":", value)
  #          print 'type(key) is ', type(value[2]) 
        ...
        eff_b_lf_shapeLine    =  'CMS_eff_b_light                        shape   '
        eff_b_hf_shapeLine    =  'CMS_eff_b_heavy                        shape   '
