...
for sample, name in dictOfFiles.items():
    ...
    histos = {
        ...
        'bjet0pt'       :ROOT.TH1F('bjet0pt'    ,';Leading b-Jet p_{T} [GeV]; Events'       , 60, 25., 325.),
        'bjet1pt'       :ROOT.TH1F('bjet1pt'    ,';Subleading b-Jet p_{T} [GeV]; Events'        , 60, 25., 325.),
        ...
        'lep0pt'        :ROOT.TH1F('lep0pt'             ,';Leading Lepton p_{T} [GeV]; Events'          , 80, 15., 415.),
        'lep1pt'        :ROOT.TH1F('lep1pt'             ,';Subleading Lepton p_{T} [GeV]; Events'       , 80, 15., 415.),
        ...
        'lep0iso03'        :ROOT.TH1F('lep0iso03'             ,';Leading Lepton relIso03 [GeV]; Events'          , 50, 0., 1.),
        'lep1iso03'        :ROOT.TH1F('lep1iso03'             ,';Subleading Lepton relIso03 [GeV]; Events'          , 50, 0., 1.),
        'lep0iso04'        :ROOT.TH1F('lep0iso04'             ,';Leading Lepton relIso04 [GeV]; Events'          , 50, 0., 1.),
        'lep1iso04'        :ROOT.TH1F('lep1iso04'             ,';Subleading Lepton relIso04 [GeV]; Events'          , 50, 0., 1.),

        'sf_trk'        :ROOT.TH1F('sf_trk'             ,';Tracker SF; Events'          , 75, 0.75, 1.5),
        'sf_id'        :ROOT.TH1F('sf_id'             ,';ID SF; Events'          , 75, 0.75, 1.5),
        'sf_iso'        :ROOT.TH1F('sf_iso'             ,';ISO SF; Events'          , 75, 0.75, 1.5),
        'sf_dilep'        :ROOT.TH1F('sf_dilep'             ,';Trigger SF; Events'          , 75, 0.75, 1.5),

        'btag0sf'        :ROOT.TH1F('btag0sf'             ,';Leading b-jet SF; Events'          , 75, 0.5, 2.),
        'btag1sf'        :ROOT.TH1F('btag1sf'             ,';Subleading b-jet SF; Events'          , 75, 0.5, 2.),

        'lep_sf'        :ROOT.TH1F('lep_sf'             ,';Total lepton event SF; Events'          , 100, 0., 5.),
        'bjet_sf'        :ROOT.TH1F('bjet_sf'             ,';Total b-jet event SF; Events'          , 100, 0., 5.),
