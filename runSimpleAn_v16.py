...
def runSimplestAn(inFileURLorList, outFileURL, xsec=None, denominator=None, isSignal = False, splitSignal = None, whichChannel = 0, physRegion = None, passLoose = False):
   ...
   #             if isSignal: #fix me
    ...
    if 'ata' in fileName:
        print 'For data sample {0} countWeighted is {1}'.format(fileName, countWeighted)
...
#            if isSignal:
 #               print 'count is ', count
        ...
        for ij in xrange(0,tree.nJet):
            ...
            elif 0.4 < tree.Jet_btagCSV[ij] and tree.Jet_btagCSV[ij] < 0.8:
              #  print 'inside 0.4<...<0.8.' # before was 0.2  to 0.8
                nLooseBJets += 1
                lbjp4 = jp4
        ...
        if xsec and countWeighted != 0: 
            ...
            if nBJets > 0:
                evWgt *= tree.Jet_btagWeightCSV[0]
                if nBJets >1 and 'b' not in physRegion:
                    evWgt *= tree.Jet_btagWeightCSV[1]
...
# build HH candidate and draw mass transverse  
        ...
        histos['btagCSV0_beforeMETcut'].Fill(tree.btagWeightCSV[0], evWgt)
        histos['btagCSV1_beforeMETcut'].Fill(tree.btagWeightCSV[1], evWgt)
...
#============================
	...
	dEta_bjets = bJetsP4[0].Eta() - bJetsP4[1].Eta()
        ...
        histos['btagCSV0'].Fill(tree.btagWeightCSV[0], evWgt)
        histos['btagCSV1'].Fill(tree.btagWeightCSV[1], evWgt)
# tree->Scan("tree.Jet_btagCSV[tree.hJCidx[0]]")
        ...
        minitree.btag0 = tree.btagWeightCSV[0]
        minitree.btag1 = tree.btagWeightCSV[1]
