...
bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_350  = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2T_M-350_minitree.root")
#bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_600  = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2T_M-600_minitree.root")
#bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_650  = ROOT.TFile(dirWithMCSamples + "GluGluToBulkGravitonToHHTo2B2T_M-650_minitree.root")
...
dictOfFiles = {
    ...
    bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_350  : "GluGluToBulkGravitonToHHTo2B2T_M_350",

    #bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_600  : "GluGluToBulkGravitonToHHTo2B2T_M_600",

    #bgInputFile_GluGluToBulkGravitonToHHTo2B2T_M_650  : "GluGluToBulkGravitonToHHTo2B2T_M_650",
...
#        b_light_nomUpDown = 0 if systUnc == 'nominal' else 2 if systUnc == 'btag_lightUp' else 1 if systUnc == 'btag_lightDown' else None
 #       b_heavy_nomUpDown = 0 if systUnc == 'nominal' else 2 if systUnc == 'btag_heavyUp' else 1 if systUnc == 'btag_heavyDown' else None
        ...
        if 'Double' not in name:
            ...
            jec_up_0 = entry.Jet_corr_JECUp[entry.hJCMVAV2idx[0]]/entry.Jet_corr[entry.hJCMVAV2idx[0]] if entry.Jet_corr_JER[entry.hJCMVAV2idx[0]] != 0 else None
            jec_down_0 = entry.Jet_corr_JECDown[entry.hJCMVAV2idx[0]]/entry.Jet_corr[entry.hJCMVAV2idx[0]] if entry.Jet_corr_JER[entry.hJCMVAV2idx[0]] != 0 else None
