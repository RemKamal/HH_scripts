...
factory.BookMethod(dataloader, TMVA.Types.kBDT,
                   "BDTG",
                   "!H:!V:NTrees=350:BoostType=Grad:Shrinkage=0.1:UseBaggedGrad:GradBaggingFraction=0.5:SeparationType=GiniIndex:nCuts=30:NNodesMax=3"
                   )
