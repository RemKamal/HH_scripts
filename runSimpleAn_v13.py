...
def runSimplestAn(inFileURLorList, outFileURL, xsec=None, denominator=None, isSignal = False, splitSignal = None, whichChannel = 0, physRegion = None):
    ...
    binLabels = ['no cut', 'ele or mu channel', 'V pdgId', 'trigger', '>=2b-jets', '90<Hbb<150',  '2leps', '76<Z<106', 'met>20','hhMt>250']
...
#print 'tree is ', str(tree)
    ...
    for i in xrange(0,int(totalEntries)):
        ...
        histos['cutFlow'].Fill(2,1) # ele or mu channel
        bazinga('before v_id')
        v_id = None
        ...
        histos['cutFlow'].Fill(3,1) # splitSignal
