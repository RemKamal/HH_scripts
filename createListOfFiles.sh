...
{
    dbSamplesList=()
    readarray -t dbSamplesList < logOfSignalSamplesUnique.txt

#find . -type f \( -name "*Bulk*" -o -name "*GluHTo*" -o -name "*VBFHToBB*" -o -name "*bbHToBB*" -o -name "*ZHiggs0**" -o -name "*ToQQ*" \)  -print0 \| xargs -0 rm -f --                                                                                                                                                                                                                                                                                                                                       
    #: <<'COMMENT'                                                                                                                                          #dbSamplesList=(                                                                                                                                        # "/store/group/phys_higgs/hbb/ntuples/V25/DYToLL_1J_13TeV-amcatnloFXFX-pythia8/VHBB_HEPPY_V25/170206_153522/:0000,0001"          
    #...                                                                                                         
    #COMMENT                                                                                                                                      
           
    declare -a array=()
    readarray -t array < logOfSignalSamplesNames.txt  # -t is extremely important as it removes damn trailing space                                                                                                                                                                                                                                                                                                                                                                                                 

    #: <<'COMMENT'                                                                                                                                          #"ggZH_HToBB_ZToLL_M125"                                                                                                                                # ...                                                                                                                                                   #)                                                                                                                                                      #COMMENT                                                                                                                                                

#prefix='/store/user/arizzi/VHBBHeppyV24'                                                                                                                  # usage:  sh createListOfBGFiles.sh                                                                                                                     
    xrdLine='find '
    i=0
...
#sed -i '/Bulk/d;/GluHTo/d;/VBFHToBB/d;/ZHiggs0/d;/bbHToBB/d;/ToQQ/d' samplesRemaining.txt                                                                                                                                                                                                                                                                                                                                                                                                   
    ...
    printf "%s\n" "${samplesRemaining[@]}" > signalSamplesFinal.txt
...
#find . -type f \( -name "*Bulk*" -o -name "*GluHTo*" -o -name "*VBFHToBB*" -o -name "*bbHToBB*" -o -name "*ZHiggs0**" -o -name "*ToQQ*" \)  -print0 \| xargs -0 rm -f --                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
    ...
    #: <<'COMMENT'                                                                                                                                           #dbSamplesList=(                                                                                                                                         #"/store/group/phys_higgs/hbb/ntuples/V25/DYToLL_1J_13TeV-amcatnloFXFX-pythia8/VHBB_HEPPY_V25/170206_153522/:0000,0001"                                  #...                                                                                                                                                     #COMMENT                                                                                                                                                 #)                                                                                                                                                      
    declare -a array=()
...
Data()
{
    readarray -t dbSamplesList < logOfDataSamplesUnique.txt

#find . -type f \( -name "*Bulk*" -o -name "*GluHTo*" -o -name "*VBFHToBB*" -o -name "*bbHToBB*" -o -name "*ZHiggs0**" -o -name "*ToQQ*" \)  -print0 \| xargs -0 rm -f --                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       

#: <<'COMMENT'                                                                                                                                              #    dbSamplesList=(                                                                                                                                     #"/store/group/phys_higgs/hbb/ntuples/V25/DYToLL_1J_13TeV-amcatnloFXFX-pythia8/VHBB_HEPPY_V25/170206_153522/:0000,0001"                                  #...                                                                                                                                                     #COMMENT                                                                                                                                                 #)                                                                                                                                                                                                                                                                                                              
    declare -a array=()
    readarray -t array < logOfDataSamplesNames.txt  # -t is extremely important as it removes damn trailing space                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
    #: <<'COMMENT'                                                                                                                                           #"ggZH_HToBB_ZToLL_M125"                                                                                                                                 #...                                                                                                                                                     #)                                                                                                                                                       #COMMENT                                                                                                                                                 
...
#sed -i '/Bulk/d;/GluHTo/d;/VBFHToBB/d;/ZHiggs0/d;/bbHToBB/d;/ToQQ/d' samplesRemaining.txt                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    ...
    printf "%s\n" "${samplesRemaining[@]}" > dataSamplesFinal.txt
