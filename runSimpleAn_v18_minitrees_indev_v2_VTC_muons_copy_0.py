...
#newLepton0 newLepton1  newVBoson                                                                                                                                                          
        ...
        histos['cutFlow'].Fill(12, 1) # N of b-jets    
       ...
       # print 'after tmpt, bJetsP4 is ', bJetsP4
        ...
        histos['cutFlow'].Fill(13, 1)# Htobb mass    
        ...
        if passLoose:
            ...
            #print 'nLeps is', nLeps
            if nLeps != 2: continue 
        histos['cutFlow'].Fill(14, 1)# 2 leptons
        ...
        bazinga ('before TLVs')
        histos['cutFlow'].Fill(15,1) # Dilepton mass
...
#============================
	...
	dEta_bjets = bJetsP4[0].Eta() - bJetsP4[1].Eta()
        ...
        histos['cutFlow'].Fill(16,1) # met cut   
        ...
        histos['cutFlow'].Fill(17,1)# HH_mt cut           
