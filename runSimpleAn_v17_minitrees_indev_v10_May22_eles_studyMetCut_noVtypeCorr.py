...
def runSimplestAn(inFileURLorList, outFileURL, xsec=None, denominator=None, isSignal = False, splitSignal = None, whichChannel = 0, physRegion = None, passLoose = False):
    ...
    binLabels = ['no cut', 'splitSignal', 'ele or mu channel', 'trigger', '>=2b-jets', 'Hbb mass',  '2leps', 'Z mass', 'met cut','hhMt cut', 'final bin']
...
#print 'tree is ', str(tree)
    ...
    for i in xrange(0,int(totalEntries)):
        ...
        if recomputeVtype:
            ...
            if (whichChannel == 0 or whichChannel ==1 ):# and recomputeVtype:
            ...
            #Vtype_new[0] = Vtype_new_                                                                                                                                                     
                ...
                if newVLeptons.pt[1] == -1 or newVBoson.pt  == -1:
                    print 'check newVBoson or newVLeptons, exiting...'
                    sys.exit(1)
...
#============================
    ...
    #print 'nbins in cutFlow histo', nbins, 
        histos['cutFlow'].Fill(11,1)# just the last bin
