...
def doFits():
    ...
    fit_CRs = 'text2workspace.py copy_dataCard_' + CRDY_type + 'nTT_hhMt.txt && combine -M MaxLikelihoodFit -v 3  --X-rtd MINIMIZER_analytic  --cminDefaultMinimizerStrategy 0 ' + extra + ' --saveShapes --saveNormalizations --saveWithUncertainties -m ' + mass + range_ + 'copy_dataCard_' + CRDY_type + 'nTT_hhMt.root >& log_fit_CRs.txt' 

    fit_all = 'text2workspace.py copy_dataCard_all_hhMt.txt && combine -M MaxLikelihoodFit -v 3  --X-rtd MINIMIZER_analytic  --cminDefaultMinimizerStrategy 0 ' + extra + ' --saveShapes --saveNormalizations --saveWithUncertainties -m ' + mass + range_ + 'copy_dataCard_all_hhMt.root >& log_fit_all.txt'  
