...
for sample, name in dictOfFiles.items():
    ...
    histos = {
        ...
        'bjet0pt'       :ROOT.TH1F('bjet0pt'    ,';Leading b-Jet p_{T} [GeV]; Events'       , 70, 20., 300.),
        'bjet1pt'       :ROOT.TH1F('bjet1pt'    ,';Subleading b-Jet p_{T} [GeV]; Events'        , 70, 20., 300.),
        'bjet0eta'      :ROOT.TH1F('bjet0eta'   ,';Leading b-Jet #eta; Events'                          , 40, -2.4, 2.4),
        'bjet1eta'      :ROOT.TH1F('bjet1eta'   ,';Subleading b-Jet #eta; Events'                       , 40, -2.4, 2.4),
        'btagDiscr0'       :ROOT.TH1F('btagDiscrCSV0'  ,';Leading b-Jet CMVAV2 discriminant; Events'            , 75, -0.5, 1.),
        'btagDiscr1'       :ROOT.TH1F('btagDiscrCSV1'  ,';Subleading b-Jet CMVAV2 discriminant; Events'         , 75, -0.5, 1.),

        'lep0pt'        :ROOT.TH1F('lep0pt'             ,';Leading Lepton p_{T} [GeV]; Events'          , 75, 0., 150.),
        'lep1pt'        :ROOT.TH1F('lep1pt'             ,';Subleading Lepton p_{T} [GeV]; Events'       , 75, 0., 150.),
        'lep0eta'       :ROOT.TH1F('lep0eta'    ,';Leading Lepton #eta ; Events'                    , 40, -2.4, 2.4),
        'lep1eta'       :ROOT.TH1F('lep1eta'    ,';Subleading Lepton #eta ; Events'             , 40, -2.4, 2.4),

        'lep0iso03'        :ROOT.TH1F('lep0iso03'             ,';Leading Lepton relIso03 [GeV]; Events'          , 50, 0., 0.4),
        'lep1iso03'        :ROOT.TH1F('lep1iso03'             ,';Subleading Lepton relIso03 [GeV]; Events'          , 50, 0., 0.4),
        'lep0iso04'        :ROOT.TH1F('lep0iso04'             ,';Leading Lepton relIso04 [GeV]; Events'          , 50, 0., 0.4),
        'lep1iso04'        :ROOT.TH1F('lep1iso04'             ,';Subleading Lepton relIso04 [GeV]; Events'          , 50, 0., 0.4),

        'sf_trk'        :ROOT.TH1F('sf_trk'             ,';Tracker SF; Events'          , 50, 0.75, 1.25),
        'sf_id'        :ROOT.TH1F('sf_id'             ,';ID SF; Events'          , 50, 0.75, 1.25),
        'sf_iso'        :ROOT.TH1F('sf_iso'             ,';ISO SF; Events'          , 50, 0.75, 1.25),
        'sf_dilep'        :ROOT.TH1F('sf_dilep'             ,';Trigger SF; Events'          , 50, 0.75, 1.25),

        'btag0sf'        :ROOT.TH1F('btag0sf'             ,';Leading b-jet SF; Events'          , 80, 0.8, 1.2),
        'btag1sf'        :ROOT.TH1F('btag1sf'             ,';Subleading b-jet SF; Events'          , 80, 0.1, 1.2),

        'lep_sf'        :ROOT.TH1F('lep_sf'             ,';Total lepton event SF; Events'          , 60, 0.5, 1.1),
        'bjet_sf'        :ROOT.TH1F('bjet_sf'             ,';Total b-jet event SF; Events'          , 80, 0.7, 1.5),
        ...
        'zmass'      :ROOT.TH1F('zmass', ';Z mass [GeV]; Events', 40, 75, 155),
        'hmass0'      :ROOT.TH1F('hmass0', ';#tilde{M}(ZZ) [GeV]; Events', 25, 75, 175),
        'hmass1'      :ROOT.TH1F('hmass1', ';Hbb mass [GeV]; Events', 40, 20, 220),
        ...
        'hpt0'      :ROOT.TH1F('hpt0', ';#tilde{p_{T}}(ZZ) [GeV]; Events', 50, 0, 300),  #?  \mbox{Z*} maybe
        'hpt1'      :ROOT.TH1F('hpt1', ';Hbb p_{T} [GeV]; Events', 50, 0, 300),
    ...
    # if systUnc not in  [
    #     'nominal',
    #     'CMS_eff_b_lightUp', 'CMS_eff_b_heavyUp', 'CMS_eff_m_IDUp', 'CMS_eff_m_ISOUp', 'CMS_eff_m_trackerUp', 'CMS_eff_m_triggerUp', 'CMS_eff_e_IDUp', 'CMS_eff_e_trackerUp', 'CMS_eff_e_triggerUp',
    #     'CMS_eff_met_JetEnUp', 'CMS_eff_met_UnclusteredEnUp', 'CMS_eff_met_JetResUp', 'CMS_scale_jUp', 'CMS_res_jUp',

    #     'CMS_eff_b_lightDown', 'CMS_eff_b_heavyDown', 'CMS_eff_m_IDDown', 'CMS_eff_m_ISODown', 'CMS_eff_m_trackerDown', 'CMS_eff_m_triggerDown', 'CMS_eff_e_IDDown', 'CMS_eff_e_trackerDown', 'CMS_eff_e_triggerDown',
    ...
    if 'eff_b' in systUnc:
        if 'light' in systUnc:
            postf = 'CMS_eff_b_lightUp' if 'Up' in systUnc else 'CMS_eff_b_lightDown' if 'Down' in systUnc else None
        elif 'heavy' in systUnc:
            postf = 'CMS_eff_b_heavyUp' if 'Up' in systUnc else 'CMS_eff_b_heavyDown' if 'Down' in systUnc else None
        else:
...
#        b_light_nomUpDown = 0 if systUnc == 'nominal' else 2 if systUnc == 'eff_b_lightUp' else 1 if systUnc == 'eff_b_lightDown' else None
 #       b_heavy_nomUpDown = 0 if systUnc == 'nominal' else 2 if systUnc == 'eff_b_heavyUp' else 1 if systUnc == 'eff_b_heavyDown' else None
        ...
        if 'eff_b' in systUnc:
            ...
            flav = '_light' if 'light' in systUnc else '_heavy' if 'heavy' in systUnc else ''
...
# build HH candidate and draw mass transverse                                                                                                 
        ...
        histos['bjet0pt'].Fill(entry.bpt0, eqLumi)
        histos['bjet1pt'].Fill(entry.bpt1, eqLumi)
        histos['bjet0eta'].Fill(entry.beta0, eqLumi)
        histos['bjet1eta'].Fill(entry.beta1, eqLumi)
        histos['btagDiscr0'].Fill(entry.btagDiscr0, eqLumi)
        histos['btagDiscr1'].Fill(entry.btagDiscr1, eqLumi)

        histos['btag0sf'].Fill(b_sf_1, eqLumi)
        histos['btag1sf'].Fill(b_sf_2, eqLumi)
        histos['bjet_sf'].Fill(btags_SF, eqLumi)

        histos['lep0pt'].Fill(entry.leppt0, eqLumi)
        histos['lep1pt'].Fill(entry.leppt1, eqLumi)
        histos['lep0eta'].Fill(entry.lepeta0, eqLumi)
        histos['lep1eta'].Fill(entry.lepeta1, eqLumi)

        histos['lep0iso03'].Fill(entry.vLeptons_pfRelIso03[0], eqLumi)
        histos['lep1iso03'].Fill(entry.vLeptons_pfRelIso03[1], eqLumi)
        histos['lep0iso04'].Fill(entry.vLeptons_pfRelIso04[0], eqLumi)
        histos['lep1iso04'].Fill(entry.vLeptons_pfRelIso04[1], eqLumi)

        histos['sf_trk'].Fill(sf_trk, eqLumi)
        histos['sf_id'].Fill(sf_id, eqLumi)
        histos['sf_iso'].Fill(sf_iso, eqLumi)
        histos['sf_dilep'].Fill(sf_trig, eqLumi)
        histos['lep_sf'].Fill(leps_SF, eqLumi)
