...
def runSimplestAn(inFileURLorList, outFileURL, xsec=None, denominator=None, isSignal = False, splitSignal = None, whichChannel = 0):#muons):
    ...
    histos={
        ...
        'btagCSV0'       :ROOT.TH1F('btagCSV0'	,';Leading b-Jet CSV weight; Events'	    , 50, -1., 1.),
        'btagCSV1'       :ROOT.TH1F('btagCSV1'	,';Subleading b-Jet CSV weight; Events'	    , 50, -1., 1.),
