...
#                elif channel == "mm" and int(mass) == 650:
 #                   rebin_factor = 20
    ...
    if True:
        ...
        if hists['ST_CMS_scale_jDown'].Integral() == 0.00 and int(mass) in [250, 600, 650, 700, 750, 800, 850, 900, 1000]:
            print 'voila here check '
            print '\n'*100
            print "hists['ST_CMS_scale_jDown'].Integral()", hists['ST_CMS_scale_jDown'].Integral()
            print "hists['ST'].Integral()", hists['ST'].Integral()
            hists['ST_CMS_scale_jDown'] = hists['ST_CMS_res_jDown'].Clone('ST_CMS_scale_jUp')
            print 'after fix'
            print "hists['ST_CMS_scale_jDown'].Integral()", hists['ST_CMS_scale_jDown'].Integral()
            print "hists['ST'].Integral()", hists['ST'].Integral()
