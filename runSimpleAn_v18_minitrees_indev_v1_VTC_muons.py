...
#print 'tree is ', str(tree)
    ...
    for i in xrange(0,int(totalEntries)):
        ...
        if recomputeVtype:
            ...
            #Vtype_new[0] = Vtype_new_                                                                                                                                                     
                ...
                if newVLeptons.pt[1] == -1: #or newVBoson.pt  == -1:
                    ...
                    continue
        histos['cutFlow'].Fill(3,1) # loose VHbb manual preselection
        ...
        histos['cutFlow'].Fill(4,1) # ele or mu channel
...
#newLepton0 newLepton1  newVBoson                                                                                                                                                          
        ...
        histos['cutFlow'].Fill(6, 1) # N of b-jets    
       ...
       # print 'after tmpt, bJetsP4 is ', bJetsP4
        ...
        histos['cutFlow'].Fill(7, 1)# Htobb mass    
        ...
        if passLoose:
            ...
            #print 'nLeps is', nLeps
            if nLeps != 2: continue 
        histos['cutFlow'].Fill(8, 1)# 2 leptons
        ...
        bazinga ('before TLVs')
        histos['cutFlow'].Fill(9,1) # Dilepton mass
...
#============================
	...
	dEta_bjets = bJetsP4[0].Eta() - bJetsP4[1].Eta()
        ...
        histos['cutFlow'].Fill(10,1) # met cut   
        ...
        histos['cutFlow'].Fill(11,1)# HH_mt cut           
