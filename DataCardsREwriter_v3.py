...
#placeholder, mofidy according to the same space separation
line_xsec_TT = "xsec_TT                                  lnN   -                   -                   3.053               -                   -                   -                   -                   \n"
line_xsec_ST = "xsec_ST                                  lnN   -                   -                   -                   -                   2.072               -                   -                   \n"
line_xsec_VV = "xsec_VV                                  lnN   0.004               -                   -                   -                   2.072               -                   -                   \n"

addXsecsManually = False
...
def processFile(fin, outfileName):
    ...
    for indx, l in enumerate(data, start=1):
        ...
        if 'xsec' in l and 'TT' in l:
            if addXsecsManually:
                l = line_xsec_TT + line_xsec_VV
            else:
                continue

        if 'xsec' in l and 'ST' in l:
            if addXsecsManually:
                l = line_xsec_ST
            else:
                continue
