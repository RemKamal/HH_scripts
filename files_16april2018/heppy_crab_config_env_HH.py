import imp
file = open( "heppy_crab_config_HH.py", 'r' )
cfg = imp.load_source( 'cfg', "heppy_crab_config_HH.py", file)
config = cfg.config
import os
import re
...
print 'final config.General.requestName=', config.General.requestName
