...
directory = 'analysis_apr23_total_SR_v3/' + '1pb_newCuts/'
...
for massRegion in ['low', 'high']:
    ...
    for mass in masses:
        ...
        for bdtCut in [-0.9, -0.5,  0, 0.4, 0.5, 0.8, 0.825, 0.85, 0.9, 0.925, 0.95, 0.99]:#[-0.9, -0.7, -0.5, -0.3, 0, 0.2, 0.5, 0.8, 0.9]:#np.arange(-0.9, 1.0, 0.1):   #[-0.24, -0.11, 0., 0.11, 0.24]:
