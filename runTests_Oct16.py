...
for typ in typeList:
    ...
    totalCmd = "nohup python runSimpleAn_v17_" + regionArgument  + "_indev_v8" + postfix + ".py  -i samplesSept21  -j data/" + json + " -w analysis_" + date + "_total_" + typ + '_' + regionArgument + version + " -r " + typ + " -n 16 -t " + runTyp + " --channel2run " + str(channel) + " &> log_" + date + "_total_" + typ + '_' + regionArgument + version + ".txt&"
    print
