...
#btagCut = -0.5884 # Loose
btagCutLoose = -0.5884 
btagCut = 0.4432  # Medium
#btagCut = 0.9432  # Tight
metCut = 40
#metCut = 75
#metCut = 100
#mass 260-300 GeV : MET > 40 GeV
#mass 350-600 GeV : MET > 75 GeV
#mass 650-1000 GeV : MET > 100 GeV
...
class Event(TreeModel):
    ...
    lep0Iso03pfR = FloatCol()
    lep1Iso03pfR = FloatCol()
    lep0Iso04pfR = FloatCol()
    lep1Iso04pfR = FloatCol()
    ...
    oldVtype = IntCol()
    newVtype = IntCol()
    event_wo_2leptons = IntCol()
    justCopyVBoson = IntCol()
    ...
    vLeptons_pfRelIso03 = FloatArrayCol(2)
    vLeptons_pfRelIso04 = FloatArrayCol(2)
...
def runSimplestAn(inFileURLorList, outFileURL, xsec=None, denominator=None, isSignal = False, splitSignal = None, whichChannel = 0, physRegion = None, passLoose = False):
    ...
    print 'outFileURL + outFileName', outFileURL + outFileName
    if passLoose:
    ...
    binLabels = ['no cut', 'splitSignal', 'inclusive >=2 leptons', 'selLeptons pdg ID 11 or 13', 'mva ID', 'ocsm and leading pt', 'eta gap',
                 'iso cut', 'manual preselection', '0 or 1 vType +2loose b jets', 'trigger', '2leps', 'Z mass loose', '>=2b-jets', 'Hbb loose',   
                 'hhMt>100', 'met>0', '90<Hbb<150', '76<Z<106']

    lastEffBin = len(binLabels)+1 #because count in lists starts with 0
    ...
    histos={
        ...
        ##################################
        'zmass_preselection' :ROOT.TH1F('zmass_preselection', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_preselection' :ROOT.TH1F('zpt_preselection', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_preselection' :ROOT.TH1F('met_preselection', ';MET [GeV]; Events', 60, 30, 330),

        'njets_preselection' :ROOT.TH1F('njets_preselection', ';N of jets; Events', 10, 0, 10),
        'nbjets_preselection' :ROOT.TH1F('nbjets_preselection', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_preselection' :ROOT.TH1F('nloosebjets_preselection', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_preselection' :ROOT.TH1F('nnonbjets_preselection', ';N of non-b jets; Events', 10, 0, 10),

        'zmass_trigger' :ROOT.TH1F('zmass_trigger', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_trigger' :ROOT.TH1F('zpt_trigger', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_trigger' :ROOT.TH1F('met_trigger', ';MET [GeV]; Events', 60, 30, 330),

        'njets_trigger' :ROOT.TH1F('njets_trigger', ';N of jets; Events', 10, 0, 10),
        'nbjets_trigger' :ROOT.TH1F('nbjets_trigger', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_trigger' :ROOT.TH1F('nloosebjets_trigger', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_trigger' :ROOT.TH1F('nnonbjets_trigger', ';N of non-b jets; Events', 10, 0, 10),


        'zmass_zmass' :ROOT.TH1F('zmass_zmass', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_zmass' :ROOT.TH1F('zpt_zmass', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_zmass' :ROOT.TH1F('met_zmass', ';MET [GeV]; Events', 60, 30, 330),

        'njets_zmass' :ROOT.TH1F('njets_zmass', ';N of jets; Events', 10, 0, 10),
        'nbjets_zmass' :ROOT.TH1F('nbjets_zmass', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_zmass' :ROOT.TH1F('nloosebjets_zmass', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_zmass' :ROOT.TH1F('nnonbjets_zmass', ';N of non-b jets; Events', 10, 0, 10),


        'zmass_2bjets' :ROOT.TH1F('zmass_2bjets', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_2bjets' :ROOT.TH1F('zpt_2bjets', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_2bjets' :ROOT.TH1F('met_2bjets', ';MET [GeV]; Events', 60, 30, 330),

        'njets_2bjets' :ROOT.TH1F('njets_2bjets', ';N of jets; Events', 10, 0, 10),
        'nbjets_2bjets' :ROOT.TH1F('nbjets_2bjets', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_2bjets' :ROOT.TH1F('nloosebjets_2bjets', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_2bjets' :ROOT.TH1F('nnonbjets_2bjets', ';N of non-b jets; Events', 10, 0, 10),

        'hbbmass_2bjets' :ROOT.TH1F('hbbmass_2bjets', '; H_{bb} mass [GeV]; Events', 40, 20, 220),
        'hbbpt_2bjets' :ROOT.TH1F('hbbpt_2bjets', ';H_{bb} p_{T} [GeV]; Events', 60, 20, 320),
        'hhmtt_2bjets' :ROOT.TH1F('hhmtt_2bjets', ';HH m_{T} [GeV]; Events', 60, 100, 1300),
        'detabb_2bjets' :ROOT.TH1F('detabb_2bjets', ';|#Delta#eta|(b_{1}, b_{2}); Events', 20, 0, 5),

        'zmass_hbb' :ROOT.TH1F('zmass_hbb', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_hbb' :ROOT.TH1F('zpt_hbb', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_hbb' :ROOT.TH1F('met_hbb', ';MET [GeV]; Events', 60, 30, 330),

        'njets_hbb' :ROOT.TH1F('njets_hbb', ';N of jets; Events', 10, 0, 10),
        'nbjets_hbb' :ROOT.TH1F('nbjets_hbb', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_hbb' :ROOT.TH1F('nloosebjets_hbb', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_hbb' :ROOT.TH1F('nnonbjets_hbb', ';N of non-b jets; Events', 10, 0, 10),

        'hbbmass_hbb' :ROOT.TH1F('hbbmass_hbb', '; H_{bb} mass [GeV]; Events', 40, 20, 220),
        'hbbpt_hbb' :ROOT.TH1F('hbbpt_hbb', ';H_{bb} p_{T} [GeV]; Events', 60, 20, 320),
        'hhmtt_hbb' :ROOT.TH1F('hhmtt_hbb', ';HH m_{T} [GeV]; Events', 60, 100, 1300),
        'detabb_hbb' :ROOT.TH1F('detabb_hbb', ';|#Delta#eta|(b_{1}, b_{2}); Events', 20, 0, 5),


        'zmass_hhmt' :ROOT.TH1F('zmass_hhmt', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_hhmt' :ROOT.TH1F('zpt_hhmt', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_hhmt' :ROOT.TH1F('met_hhmt', ';MET [GeV]; Events', 60, 30, 330),

        'njets_hhmt' :ROOT.TH1F('njets_hhmt', ';N of jets; Events', 10, 0, 10),
        'nbjets_hhmt' :ROOT.TH1F('nbjets_hhmt', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_hhmt' :ROOT.TH1F('nloosebjets_hhmt', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_hhmt' :ROOT.TH1F('nnonbjets_hhmt', ';N of non-b jets; Events', 10, 0, 10),

        'hbbmass_hhmt' :ROOT.TH1F('hbbmass_hhmt', '; H_{bb} mass [GeV]; Events', 40, 20, 220),
        'hbbpt_hhmt' :ROOT.TH1F('hbbpt_hhmt', ';H_{bb} p_{T} [GeV]; Events', 60, 20, 320),
        'hhmtt_hhmt' :ROOT.TH1F('hhmtt_hhmt', ';HH m_{T} [GeV]; Events', 60, 100, 1300),
        'detabb_hhmt' :ROOT.TH1F('detabb_hhmt', ';|#Delta#eta|(b_{1}, b_{2}); Events', 20, 0, 5),

        'zmass_met' :ROOT.TH1F('zmass_met', ';Z mass [GeV]; Events', 30, 50, 140),
        'zpt_met' :ROOT.TH1F('zpt_met', ';Z p_{T} [GeV]; Events', 60, 0, 300),
        'met_met' :ROOT.TH1F('met_met', ';MET [GeV]; Events', 60, 30, 330),

        'njets_met' :ROOT.TH1F('njets_met', ';N of jets; Events', 10, 0, 10),
        'nbjets_met' :ROOT.TH1F('nbjets_met', ';N of b jets; Events', 10, 0, 10),
        'nloosebjets_met' :ROOT.TH1F('nloosebjets_met', ';N of loose b jets; Events', 10, 0, 10),
        'nnonbjets_met' :ROOT.TH1F('nnonbjets_met', ';N of non-b jets; Events', 10, 0, 10),

        'hbbmass_met' :ROOT.TH1F('hbbmass_met', '; H_{bb} mass [GeV]; Events', 40, 20, 220),
        'hbbpt_met' :ROOT.TH1F('hbbpt_met', ';H_{bb} p_{T} [GeV]; Events', 60, 20, 320),
        'hhmtt_met' :ROOT.TH1F('hhmtt_met', ';HH m_{T} [GeV]; Events', 60, 100, 1300),
        'detabb_met' :ROOT.TH1F('detabb_met', ';|#Delta#eta|(b_{1}, b_{2}); Events', 20, 0, 5),
    ...
    if round(countWeighted, 2) ==0:# and 'Double' in inFileURLorList:
        countWeighted = count
...
#print 'tree is ', str(tree)
    ...
    for i in xrange(0,int(totalEntries)):
        ...
        lepsP4 = []
        Vtype_new_ = None
        event_wo_2leptons = False
        justCopyVBoson = False
        if recomputeVtype:
            ...
            #vLeptons_new = []
                ...
                #print
                #print 'aMuons={}, selectedMuons={}, vMuons={}'.format(aMuons, selectedMuons, vMuons)
                #print 'aElectrons={}, selectedElectrons={}, vElectrons={}'.format(aElectrons, selectedElectrons, vElectrons)

                if whichChannel ==1 and len(vElectrons+aElectrons) >=2:
                    pass
                elif whichChannel ==0 and len(vMuons+aMuons) >=2:
                    pass
                else:
                    continue
                
                histos['cutFlow'].Fill(3,1) #inclusive >=2 eles or muons

                if len(selectedElectrons) >=2 and whichChannel ==1:
                    pass
                elif  len(selectedMuons)>=2 and whichChannel ==0:
                    pass
                else:
                    continue
                histos['cutFlow'].Fill(4,1) #pdg ID
            ...
            #newLepton1 = NewVLepton(-1,-1,-1,-1,-1,-1)                                                                                       
                    #Zll case. Recompute lepton branches                                  
                if len(zMuons) >=  2 and whichChannel ==0:
                    pass
                elif len(zElectrons) >=  2 and whichChannel ==1:
                    pass
                else:
                    continue
                histos['cutFlow'].Fill(5,1) # mva preselected zMuons/zEles   
                ...
                if len(zMuons) >=  2:
                    ...
                    # event_wo_2leptons = True
                    # #if it was Vtype 0 or 1 before, there is no way now it is not reconstructed using the logic above
                    # if tree.Vtype == 0 or tree.Vtype == 1:
                    #     print 'tree.Vtype', tree.Vtype
                    #     print 'tree.vLeptons_pt', tree.vLeptons_pt
                    #     print 'tree.selLeptons_pt', tree.selLeptons_pt
                    #     print 'strange....originally @ERROR This is impossible, the new ele cut should be losser...'
                    #     ##continue 
                    #     sys.exit(1)
            ...
            #Vtype_new_ = tree.Vtype if not recomputeVtype else Vtype_new_
                ...
                if True:#whichChannel in [0, 1]:#'Zll':                                                                                                                                                           
                    if Vtype_new_ != 0 and Vtype_new_ != 1:
                        n_vtype_events_skipped += 1
                        continue
                histos['cutFlow'].Fill(6,1) # charge and pt

                                                                                                                             
                if (1.4442 < abs(newVLeptons.eta[0]) < 1.566) or (1.4442 < abs(newVLeptons.eta[1]) <1.566): continue
                histos['cutFlow'].Fill(7,1) # remove eta gap                                                                   
     
                if  Vtype_new_ == 0 and (newVLeptons.relIso03[0]>0.06 or newVLeptons.relIso03[1]>0.06): continue
                if  Vtype_new_ == 1 and (newVLeptons.relIso04[0]>0.15 or newVLeptons.relIso04[1]>0.15): continue
                histos['cutFlow'].Fill(8,1) # isolation cut                                                                                                                                                                                           
                ...
                if (Vtype_new_ == 0 or Vtype_new_ == 1) and not event_wo_2leptons:
                    if printClass_V_Objects: print 'inside Recompute'
                    if len(newVLeptons.pt) <2:
                        print 'newVLeptons.pt', newVLeptons.pt
                        print 'check newVLeptons.pt length, exiting'
                        sys.exit(1)
                    if printClass_V_Objects:
                        print 'newVLeptons.pt[0]', newVLeptons.pt[0]
                        print 'newVLeptons.eta[1]', newVLeptons.eta[1]
                    lep1 = ROOT.TLorentzVector()
                    lep2 = ROOT.TLorentzVector()
                    lep1.SetPtEtaPhiM(newVLeptons.pt[0], newVLeptons.eta[0], newVLeptons.phi[0], newVLeptons.mass[0])
                    lep2.SetPtEtaPhiM(newVLeptons.pt[1], newVLeptons.eta[1], newVLeptons.phi[1], newVLeptons.mass[1])
                #newLepton0                                                                                                                                                                
                    V = lep1+lep2
                    lepsP4.append(lep1)
                    lepsP4.append(lep2)
                    for var in Vvar:
                        tmp_Vvar= getattr(V,LorentzDic[var])() # extra() are needed since the function is Pt(), not just Pt                                                                    
                        setattr(newVBoson, var, tmp_Vvar)
                    #Use "old" lepton variables for Wlv and Zvv. i.e. only Vtype -> Vtype_new change, other _new variables are copy                                                        
                else:
                    #continue since no lepton quantities are available?
                    continue
                    #just copy
                    justCopyVBoson = True
                    for var in Vvar:                                                                                         
                        tmp_Vvar= getattr(tree,'V_%s'%var)  
                        setattr(newVBoson, var, tmp_Vvar)
                     
                if printClass_V_Objects:
                    print 'justCopyVBoson=', justCopyVBoson
                    print 'newVBoson', newVBoson
                    print 'tree.V_mass', tree.V_mass
            #Vtype_new[0] = Vtype_new_                                                                                                                                                     

                    print 'Vtype_new_', Vtype_new_

                    print 'before verifying status'
                if newVLeptons.pt[1] == -1: #or newVBoson.pt  == -1:
                    print 'no new two leptons, skippin...'
                    continue

        Vmass = newVBoson.mass if recomputeVtype else tree.V_mass
        Vpt = newVBoson.pt if recomputeVtype else tree.V_pt
        nLeps = len(newVLeptons.pt) if recomputeVtype else 0

        histos['cutFlow'].Fill(9,1) # manual preselection
        Vtype_new_ = Vtype_new_ if recomputeVtype else tree.Vtype

        if whichChannel == 0: #muons
            if Vtype_new_ !=0: continue #tree.Vtype != 0: continue
                
        elif whichChannel == 1: #electrons
            if Vtype_new_ !=1: continue #tree.Vtype != 1: continue
        else:
            print 'wrong channel type, only electron or muon are possible, exiting...'
            sys.exit(1)

        histos['cutFlow'].Fill(10,1) # ele or mu channel
...
#            if isSignal:
 #               print 'count is ', count
        ...
        nJets , nBJets, nLooseBJets, nNonBJets = 0,0,0,0
        jetsP4 = []
        looseBJetsListOfTuples = []
        nonBJetsListOfTuples = []
        bJetsListOfTuples =[]
        ...
        for ij in xrange(0,tree.nJet):
            ...
            if tree.Jet_btagCMVAV2[ij]>= btagCut:
            #pfCombinedMVAV2BJetTagsCombinedMVA v2cMVAv2L -0.5884 cMVAv2_Moriond17_B_H.csv Mistag SFs for light jets are also available for separate periods, see details below hereto be used only in ttbar jet pT regime, new WP!!!
             ...
             #   print 'inside >=0.8'
            ...
            elif btagCutLoose < tree.Jet_btagCMVAV2[ij] and tree.Jet_btagCMVAV2[ij] < btagCut: 
                ...
                nNonBJets += 1
                nonbjp4 = jp4
                nonBJetsListOfTuples.append( (nonbjp4,tree.Jet_btagCMVAV2[ij]) )
                #continue #pass
        ...
        nonBJetsListOfTuples_tmp = sorted(nonBJetsListOfTuples, key=itemgetter(1), reverse = True)
        nonBJetsP4_sortedByCMVAV2 = map(itemgetter(0), nonBJetsListOfTuples_tmp )
        nonBJetsCMVAV2 = map(itemgetter(1), nonBJetsListOfTuples_tmp )
        
        tmpBJet = bJetsP4 + looseBJetsP4_sortedByCMVAV2
	if len(bJetsP4)>=2:
            dEta_bjets = bJetsP4[0].Eta() - bJetsP4[1].Eta()
        elif len(tmpBJet)>=2:
            dEta_bjets = tmpBJet[0].Eta() - tmpBJet[1].Eta()
        else:
            continue

        dyLOtoNLOw = 1.
        EWKw = 1.
        etabb = abs(dEta_bjets)
        if ('DY' in fileName and 'Jets' in fileName) or ('DY' in outFileURL and 'Jets' in outFileURL):
        ...
        b_sf_1, b_sf_2 = 1, 1
        if len(tree.hJCMVAV2idx) >=2 and 'Double' not in fileName:
            branch_1 = getattr(tree, 'Jet_btagWeightCMVAV2{0}{1}'.format(b_nomUpDown, flav), None)
            branch_2 = getattr(tree, 'Jet_btagWeightCMVAV2{0}{1}'.format(b_nomUpDown, flav), None)
            if branch_1 != None and branch_2 != None:
                b_sf_1 = branch_1[tree.hJCMVAV2idx[0]]
                b_sf_2 = branch_2[tree.hJCMVAV2idx[1]]
                #b_sf_1 = getattr(tree, 'Jet_btagWeightCMVAV2{0}{1}'.format(b_nomUpDown, flav), None)[tree.hJCMVAV2idx[0]]
                #b_sf_2 = getattr(tree, 'Jet_btagWeightCMVAV2{0}{1}'.format(b_nomUpDown, flav), None)[tree.hJCMVAV2idx[1]]
        else:
            pass

        if (not b_sf_1 or not b_sf_2) and 'Double' not in fileName:
            print 'problem with b_sf_ in MC, exiting...'
            sys.exit(1)

        btags_SF = b_sf_1 * b_sf_2  if 'Double' not in fileName else 1
        ...
        if recomputeVtype:
            #print 'inside recomputeVtype'
#newLepton0 newLepton1  newVBoson                                                                                                                                                          
            minitree.vLeptons_pt = newVLeptons.pt
            minitree.vLeptons_eta = newVLeptons.eta
            minitree.vLeptons_phi = newVLeptons.phi
            minitree.vLeptons_mass = newVLeptons.mass
        else:
        ...
        if True:#not recomputeVtype:
            if len(lepsP4) != nLeps: #nvLeps:
                print 'nLeps is {0}, while nvLeps is {1}....exiting...'.format ( nLeps, nvLeps )
                sys.exit(1)
        ...
        if not recomputeVtype:
            ...
            if len(tree.vLeptons_pt) < 2: continue
        ...
        for j, name in SFjsons.iteritems():
            #print j
            #print 'name[0]={}, name[1]={}'.format(name[0], name[1])
            weight = []
            lepCorr = LeptonSF(j , name[0], name[1])
            #2-D binned SF
            if not j.find('trk_SF_Run') != -1 and not j.find('EfficienciesAndSF_dZ_numH') != -1:
                #will use json files which have no 'trk_SF_Run' in name and also no 'EfficienciesAndSF_dZ_numH' in name
                ...
                #will use json files which have no 'trk_SF_Run' in name but contains 'EfficienciesAndSF_dZ_numH' in name
                weight.append(lepCorr.get_2D(lepsP4[0].Eta(), lepsP4[1].Eta() ) )
                weight.append(lepCorr.get_2D(lepsP4[1].Eta(), lepsP4[0].Eta() ) )
            else:
            #1-D binned SF
                ##will use json files which HAVE 'trk_SF_Run' in name
                weight.append(lepCorr.get_1D(lepsP4[0].Eta()))
                weight.append(lepCorr.get_1D(lepsP4[1].Eta()))

            
            if Vtype_new_ ==0:#tree.Vtype == 0: #whichChannel ==0
            ...
            elif Vtype_new_ ==1:#tree.Vtype == 1: #whichChannel ==1
        ...
        leps_SF = minitree.weight_SF_LooseIDnISO[0] * minitree.weight_SF_TRK[0] * minitree.weight_SF_Dilep[0]
        if xsec and countWeighted != 0 and 'Double' not in fileName: 
            ...
            eqLumi = evWgt * extraWeight * dyLOtoNLOw * EWKw # the last two are 1 and 1 for non DY or non Jets
            #reassign not to modify all old code below
            evWgt = eqLumi
            if i%200==0:
                print 'evWgt is ', evWgt
                # if 'Hzz' in splitSignal or '2B2Z' in fileName:
        ...
        histos['zmass_preselection'].Fill(Vmass, evWgt)
        histos['zpt_preselection'].Fill(Vpt, evWgt)
        histos['met_preselection'].Fill(tree.met_pt, evWgt)
        
        histos['njets_preselection'].Fill(nJets, evWgt)
        histos['nbjets_preselection'].Fill(nBJets, evWgt)
        histos['nloosebjets_preselection'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_preselection'].Fill(nNonBJets, evWgt)

        if Vtype_new_ == 1: #tree.Vtype == 1: #Int_t OR of ['HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v*', 'HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v*']*
            #if not tree.HLT_ttH_DL_elel: continue

            if not tree.HLT_BIT_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v: continue  
            #as in vhbb AN

        elif Vtype_new_ == 0:#tree.Vtype == 0:
...
#Int_t OR of ['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v*', 'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v*']*
            ...
            continue
            #pass
        histos['cutFlow'].Fill(11,1) #trigger
        

        histos['zmass_trigger'].Fill(Vmass, evWgt)
        histos['zpt_trigger'].Fill(Vpt, evWgt)
        histos['met_trigger'].Fill(tree.met_pt, evWgt)
        
        histos['njets_trigger'].Fill(nJets, evWgt)
        histos['nbjets_trigger'].Fill(nBJets, evWgt)
        histos['nloosebjets_trigger'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_trigger'].Fill(nNonBJets, evWgt)
        ...
        #*******************
            ...
            #print 'nLeps is', nLeps
        if nLeps != 2: continue 
        histos['cutFlow'].Fill(12, 1)# 2 leptons
        ...
        if physRegion == "SR" and not passLoose:
            ...
            if Vmass <76 or Vmass > 106 : continue
        elif physRegion == "SR" and passLoose:
            bazinga('in passLoose with Vmass is {0}'.format(Vmass) )
            #if Vmass < 76: continue# or Vmass > 126 : continue   #CHANGED
            if Vmass < 76:# or Vmass > 126 : 
                continue   #CHANGED
        elif physRegion == "CRTT":
            #print 'doing ', physRegion
            if Vmass >= 76 and Vmass <= 106 : continue
            ...
            sys.exit(1)
        histos['cutFlow'].Fill(13,1) # Dilepton mass

        histos['zmass_zmass'].Fill(Vmass, evWgt)
        histos['zpt_zmass'].Fill(Vpt, evWgt)
        histos['met_zmass'].Fill(tree.met_pt, evWgt)
        
        histos['njets_zmass'].Fill(nJets, evWgt)
        histos['nbjets_zmass'].Fill(nBJets, evWgt)
        histos['nloosebjets_zmass'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_zmass'].Fill(nNonBJets, evWgt)
...
# build HH candidate and draw mass transverse  
        ...
        if recomputeVtype:
            Z_p4.SetPtEtaPhiM(newVBoson.pt,newVBoson.eta,newVBoson.phi,newVBoson.mass)   
        else:
       ...
       # print 'after tmpt, bJetsP4 is ', bJetsP4
        ...
        histos['cutFlow'].Fill(14, 1) # N of b-jets    

        histos['zmass_2bjets'].Fill(Vmass, evWgt)
        histos['zpt_2bjets'].Fill(Vpt, evWgt)
        histos['met_2bjets'].Fill(tree.met_pt, evWgt)
        
        histos['njets_2bjets'].Fill(nJets, evWgt)
        histos['nbjets_2bjets'].Fill(nBJets, evWgt)
        histos['nloosebjets_2bjets'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_2bjets'].Fill(nNonBJets, evWgt)

        histos['hbbmass_2bjets'].Fill(Htobb_p4.M(), evWgt)
        histos['hbbpt_2bjets'].Fill(Htobb_p4.Pt(), evWgt)
        histos['hhmtt_2bjets'].Fill(hh_Mt, evWgt)
        histos['detabb_2bjets'].Fill(etabb, evWgt)
        ...
        histos['zmass_hbb'].Fill(Vmass, evWgt)
        histos['zpt_hbb'].Fill(Vpt, evWgt)
        histos['met_hbb'].Fill(tree.met_pt, evWgt)
        
        histos['njets_hbb'].Fill(nJets, evWgt)
        histos['nbjets_hbb'].Fill(nBJets, evWgt)
        histos['nloosebjets_hbb'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_hbb'].Fill(nNonBJets, evWgt)

        histos['hbbmass_hbb'].Fill(Htobb_p4.M(), evWgt)
        histos['hbbpt_hbb'].Fill(Htobb_p4.Pt(), evWgt)
        histos['hhmtt_hbb'].Fill(hh_Mt, evWgt)
        histos['detabb_hbb'].Fill(etabb, evWgt)


        histos['cutFlow'].Fill(15, 1)# Htobb mass    
        bazinga ('before TLVs')
...
# tree->Scan("tree.Jet_btagCMVAV2[tree.hJCidx[0]]")
        ...
        if recomputeVtype:
            histos['zMass_beforeMETcut'].Fill(Vmass, evWgt)
        else:
        ...
        if recomputeVtype:
            histos['zMass_long_beforeMETcut'].Fill(Vmass, evWgt)
        else:
...
#============================
        ...
        histos['cutFlow'].Fill(16,1)# HH_mt cut           


        histos['zmass_hhmt'].Fill(Vmass, evWgt)
        histos['zpt_hhmt'].Fill(Vpt, evWgt)
        histos['met_hhmt'].Fill(tree.met_pt, evWgt)
        
        histos['njets_hhmt'].Fill(nJets, evWgt)
        histos['nbjets_hhmt'].Fill(nBJets, evWgt)
        histos['nloosebjets_hhmt'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_hhmt'].Fill(nNonBJets, evWgt)

        histos['hbbmass_hhmt'].Fill(Htobb_p4.M(), evWgt)
        histos['hbbpt_hhmt'].Fill(Htobb_p4.Pt(), evWgt)
        histos['hhmtt_hhmt'].Fill(hh_Mt, evWgt)
        histos['detabb_hhmt'].Fill(etabb, evWgt)


        if not passLoose:
            if tree.met_pt < metCut: continue    
        else:
            if tree.met_pt < 0: continue 

        histos['cutFlow'].Fill(17,1) # met cut   


        histos['zmass_met'].Fill(Vmass, evWgt)
        histos['zpt_met'].Fill(Vpt, evWgt)
        histos['met_met'].Fill(tree.met_pt, evWgt)
        
        histos['njets_met'].Fill(nJets, evWgt)
        histos['nbjets_met'].Fill(nBJets, evWgt)
        histos['nloosebjets_met'].Fill(nLooseBJets, evWgt)
        histos['nnonbjets_met'].Fill(nNonBJets, evWgt)

        histos['hbbmass_met'].Fill(Htobb_p4.M(), evWgt)
        histos['hbbpt_met'].Fill(Htobb_p4.Pt(), evWgt)
        histos['hhmtt_met'].Fill(hh_Mt, evWgt)
        histos['detabb_met'].Fill(etabb, evWgt)
...
# tree->Scan("tree.Jet_btagCMVAV2[tree.hJCidx[0]]")
        ...
        if recomputeVtype:
            minitree.zmass = newVBoson.mass
            minitree.zpt0 = newVBoson.pt 
            minitree.zeta0 = newVBoson.eta
            minitree.zphi0 = newVBoson.phi
        else:
        ...
        minitree.nnonbjets = nNonBJets
        minitree.nleps = nLeps
        minitree.oldVtype = tree.Vtype
        minitree.event_wo_2leptons = event_wo_2leptons
        minitree.justCopyVBoson = justCopyVBoson
        minitree.newVtype = Vtype_new_
        ...
        minitree.vLeptons_pfRelIso03 = tree.vLeptons_pfRelIso03
        minitree.vLeptons_pfRelIso04 = tree.vLeptons_pfRelIso04
        
        #print 'minitree.vLeptons_pfRelIso03', minitree.vLeptons_pfRelIso03
        #print 'minitree.vLeptons_pfRelIso04', minitree.vLeptons_pfRelIso04

        if recomputeVtype:
            minitree.lep0Iso03 = newVLeptons.relIso03[0]
            minitree.lep1Iso03 = newVLeptons.relIso03[1]
            minitree.lep0Iso04 = newVLeptons.relIso04[0]
            minitree.lep1Iso04 = newVLeptons.relIso04[1]

            minitree.lep0Iso03pfR = newVLeptons.pfRelIso03[0]
            minitree.lep1Iso03pfR = newVLeptons.pfRelIso03[1]
            minitree.lep0Iso04pfR = newVLeptons.pfRelIso04[0]
            minitree.lep1Iso04pfR = newVLeptons.pfRelIso04[1]
        else:
             minitree.lep0Iso03 = tree.vLeptons_relIso03[0]
             minitree.lep1Iso03 = tree.vLeptons_relIso03[1]
             minitree.lep0Iso04 = tree.vLeptons_relIso04[0]
             minitree.lep1Iso04 = tree.vLeptons_relIso04[1]

             minitree.lep0Iso03pfR = tree.vLeptons_pfRelIso03[0]
             minitree.lep1Iso03pfR = tree.vLeptons_pfRelIso03[1]
             minitree.lep0Iso04pfR = tree.vLeptons_pfRelIso04[0]
             minitree.lep1Iso04pfR = tree.vLeptons_pfRelIso04[1]


        #print 'lep0Iso03, lep1Iso03, lep0Iso04, lep1Iso04, are:', minitree.lep0Iso03, minitree.lep1Iso03, minitree.lep0Iso04, minitree.lep1Iso04
...
#============================
	...
	# dEta_bjets = bJetsP4[0].Eta() - bJetsP4[1].Eta()
        ...
        if Htobb_p4.M() < 90 or Htobb_p4.M() > 150: continue
        histos['cutFlow'].Fill(18, 1)
        if Vmass <76 or Vmass > 106 : continue
        histos['cutFlow'].Fill(19, 1)
    ...
    #print 'nbins in cutFlow histo', nbins, 
        #histos['cutFlow'].Fill(12,1)# just the last bin
    ...
    if not passLoose:
        ...
        print 'about to save new histograms'
