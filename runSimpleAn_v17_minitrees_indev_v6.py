...
class Event(TreeModel):
    ...
    Jet_hadronFlavour = IntArrayCol(20)
    ...
    Jet_btagCMVAV2 = FloatArrayCol(20)
    Jet_btagCMVAV2L_SF = FloatArrayCol(20)
    Jet_btagCMVAV2L_SF_up = FloatArrayCol(20)
    Jet_btagCMVAV2L_SF_down = FloatArrayCol(20)
    Jet_btagCMVAV2M_SF = FloatArrayCol(20)
    Jet_btagCMVAV2M_SF_up = FloatArrayCol(20)
    Jet_btagCMVAV2M_SF_down = FloatArrayCol(20)
    Jet_btagCMVAV2T_SF = FloatArrayCol(20)
    Jet_btagCMVAV2T_SF_up = FloatArrayCol(20)
    Jet_btagCMVAV2T_SF_down = FloatArrayCol(20)
    Jet_btagWeightCMVAV2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_jes = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_jes = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_lf = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_lf = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_hf = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_hf = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_hfstats1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_hfstats1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_hfstats2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_hfstats2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_lfstats1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_lfstats1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_lfstats2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_lfstats2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_cferr1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_cferr1 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_up_cferr2 = FloatArrayCol(20)
    Jet_btagWeightCMVAV2_down_cferr2 = FloatArrayCol(20)


    Jet_corr_JECUp = FloatArrayCol(20)
    Jet_corr_JECDown = FloatArrayCol(20)
    Jet_corr = FloatArrayCol(20)
    Jet_corr_JERUp = FloatArrayCol(20)
    Jet_corr_JERDown = FloatArrayCol(20)
    Jet_corr_JER = FloatArrayCol(20)
    Jet_corr_AbsoluteStatUp = FloatArrayCol(20)
    Jet_corr_AbsoluteStatDown = FloatArrayCol(20)
    Jet_corr_AbsoluteScaleUp = FloatArrayCol(20)
    Jet_corr_AbsoluteScaleDown = FloatArrayCol(20)
    Jet_corr_AbsoluteFlavMapUp = FloatArrayCol(20)
    Jet_corr_AbsoluteFlavMapDown = FloatArrayCol(20)
    Jet_corr_AbsoluteMPFBiasUp = FloatArrayCol(20)
    Jet_corr_AbsoluteMPFBiasDown = FloatArrayCol(20)
    Jet_corr_FragmentationUp = FloatArrayCol(20)
    Jet_corr_FragmentationDown = FloatArrayCol(20)
    Jet_corr_SinglePionECALUp = FloatArrayCol(20)
    Jet_corr_SinglePionECALDown = FloatArrayCol(20)
    Jet_corr_SinglePionHCALUp = FloatArrayCol(20)
    Jet_corr_SinglePionHCALDown = FloatArrayCol(20)
    Jet_corr_FlavorQCDUp = FloatArrayCol(20)
    Jet_corr_FlavorQCDDown = FloatArrayCol(20)
    Jet_corr_TimePtEtaUp = FloatArrayCol(20)
    Jet_corr_TimePtEtaDown = FloatArrayCol(20)
    Jet_corr_RelativeJEREC1Up = FloatArrayCol(20)
    Jet_corr_RelativeJEREC1Down = FloatArrayCol(20)
    Jet_corr_RelativeJEREC2Up = FloatArrayCol(20)
    Jet_corr_RelativeJEREC2Down = FloatArrayCol(20)
    Jet_corr_RelativeJERHFUp = FloatArrayCol(20)
    Jet_corr_RelativeJERHFDown = FloatArrayCol(20)
    Jet_corr_RelativePtBBUp = FloatArrayCol(20)
    Jet_corr_RelativePtBBDown = FloatArrayCol(20)
    Jet_corr_RelativePtEC1Up = FloatArrayCol(20)
    Jet_corr_RelativePtEC1Down = FloatArrayCol(20)
    Jet_corr_RelativePtEC2Up = FloatArrayCol(20)
    Jet_corr_RelativePtEC2Down = FloatArrayCol(20)
    Jet_corr_RelativePtHFUp = FloatArrayCol(20)
    Jet_corr_RelativePtHFDown = FloatArrayCol(20)
    Jet_corr_RelativeBalUp = FloatArrayCol(20)
    Jet_corr_RelativeBalDown = FloatArrayCol(20)
    Jet_corr_RelativeFSRUp = FloatArrayCol(20)
    Jet_corr_RelativeFSRDown = FloatArrayCol(20)
    Jet_corr_RelativeStatFSRUp = FloatArrayCol(20)
    Jet_corr_RelativeStatFSRDown = FloatArrayCol(20)
    Jet_corr_RelativeStatECUp = FloatArrayCol(20)
    Jet_corr_RelativeStatECDown = FloatArrayCol(20)
    Jet_corr_RelativeStatHFUp = FloatArrayCol(20)
    Jet_corr_RelativeStatHFDown = FloatArrayCol(20)
    Jet_corr_PileUpDataMCUp = FloatArrayCol(20)
    Jet_corr_PileUpDataMCDown = FloatArrayCol(20)
    Jet_corr_PileUpPtRefUp = FloatArrayCol(20)
    Jet_corr_PileUpPtRefDown = FloatArrayCol(20)
    Jet_corr_PileUpPtBBUp = FloatArrayCol(20)
    Jet_corr_PileUpPtBBDown = FloatArrayCol(20)
    Jet_corr_PileUpPtEC1Up = FloatArrayCol(20)
    Jet_corr_PileUpPtEC1Down = FloatArrayCol(20)
    Jet_corr_PileUpPtEC2Up = FloatArrayCol(20)
    Jet_corr_PileUpPtEC2Down = FloatArrayCol(20)
    Jet_corr_PileUpPtHFUp = FloatArrayCol(20)
    Jet_corr_PileUpPtHFDown = FloatArrayCol(20)
    Jet_corr_PileUpMuZeroUp = FloatArrayCol(20)
    Jet_corr_PileUpMuZeroDown = FloatArrayCol(20)
    Jet_corr_PileUpEnvelopeUp = FloatArrayCol(20)
    Jet_corr_PileUpEnvelopeDown = FloatArrayCol(20)
    Jet_corr_SubTotalPileUpUp = FloatArrayCol(20)
    Jet_corr_SubTotalPileUpDown = FloatArrayCol(20)
    Jet_corr_SubTotalRelativeUp = FloatArrayCol(20)
    Jet_corr_SubTotalRelativeDown = FloatArrayCol(20)
    Jet_corr_SubTotalPtUp = FloatArrayCol(20)
    Jet_corr_SubTotalPtDown = FloatArrayCol(20)
    Jet_corr_SubTotalScaleUp = FloatArrayCol(20)
    Jet_corr_SubTotalScaleDown = FloatArrayCol(20)
    Jet_corr_SubTotalAbsoluteUp = FloatArrayCol(20)
    Jet_corr_SubTotalAbsoluteDown = FloatArrayCol(20)
    Jet_corr_SubTotalMCUp = FloatArrayCol(20)
    Jet_corr_SubTotalMCDown = FloatArrayCol(20)
    Jet_corr_TotalUp = FloatArrayCol(20)
    Jet_corr_TotalDown = FloatArrayCol(20)
    Jet_corr_TotalNoFlavorUp = FloatArrayCol(20)
    Jet_corr_TotalNoFlavorDown = FloatArrayCol(20)
    Jet_corr_TotalNoTimeUp = FloatArrayCol(20)
    Jet_corr_TotalNoTimeDown = FloatArrayCol(20)
    Jet_corr_TotalNoFlavorNoTimeUp = FloatArrayCol(20)
    Jet_corr_TotalNoFlavorNoTimeDown = FloatArrayCol(20)
    Jet_corr_FlavorZJetUp = FloatArrayCol(20)
    Jet_corr_FlavorZJetDown = FloatArrayCol(20)
    Jet_corr_FlavorPhotonJetUp = FloatArrayCol(20)
    Jet_corr_FlavorPhotonJetDown = FloatArrayCol(20)
    Jet_corr_FlavorPureGluonUp = FloatArrayCol(20)
    Jet_corr_FlavorPureGluonDown = FloatArrayCol(20)
    Jet_corr_FlavorPureQuarkUp = FloatArrayCol(20)
    Jet_corr_FlavorPureQuarkDown = FloatArrayCol(20)
    Jet_corr_FlavorPureCharmUp = FloatArrayCol(20)
    Jet_corr_FlavorPureCharmDown = FloatArrayCol(20)
    Jet_corr_FlavorPureBottomUp = FloatArrayCol(20)
    Jet_corr_FlavorPureBottomDown = FloatArrayCol(20)
    Jet_corr_TimeRunBCDUp = FloatArrayCol(20)
    Jet_corr_TimeRunBCDDown = FloatArrayCol(20)
    Jet_corr_TimeRunEFUp = FloatArrayCol(20)
    Jet_corr_TimeRunEFDown = FloatArrayCol(20)
    Jet_corr_TimeRunGUp = FloatArrayCol(20)
    Jet_corr_TimeRunGDown = FloatArrayCol(20)
    Jet_corr_TimeRunHUp = FloatArrayCol(20)
    Jet_corr_TimeRunHDown = FloatArrayCol(20)
    Jet_corr_CorrelationGroupMPFInSituUp = FloatArrayCol(20)
    Jet_corr_CorrelationGroupMPFInSituDown = FloatArrayCol(20)
    Jet_corr_CorrelationGroupIntercalibrationUp = FloatArrayCol(20)
    Jet_corr_CorrelationGroupIntercalibrationDown = FloatArrayCol(20)
    Jet_corr_CorrelationGroupbJESUp = FloatArrayCol(20)
    Jet_corr_CorrelationGroupbJESDown = FloatArrayCol(20)
    Jet_corr_CorrelationGroupFlavorUp = FloatArrayCol(20)
    Jet_corr_CorrelationGroupFlavorDown = FloatArrayCol(20)
    Jet_corr_CorrelationGroupUncorrelatedUp = FloatArrayCol(20)
    Jet_corr_CorrelationGroupUncorrelatedDown = FloatArrayCol(20)

    hJCMVAV2idx = IntArrayCol(20)   
    hJidx = IntArrayCol(20)   
...
#            if isSignal:
 #               print 'count is ', count
        ...
        if xsec is None:
            ...
            minitree.Jet_btagWeightCMVAV2lead = tree.Jet_btagWeightCMVAV2[tree.hJCMVAV2idx[1]]      
...
#============================
    ...
    if not passLoose:
        ...
        print 'in the outpur minitree storing {0} events'.format(minitree.GetEntries())
        minitree.write()
    #minitree.vals.reset()
