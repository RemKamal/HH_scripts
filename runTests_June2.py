...
#runSimpleAn_v18_minitrees_indev_v1_muons_VTC.py runSimpleAn_v18_minitrees_indev_v1_VTC_muons_copy.py
        ...
        totalCmd = "nohup python runSimpleAn_v18_" + regionArgument  + "_indev_v2_VTC" + postfix + "_copy_0.py  -i samples20May2018  -j data/" + json + " -w analysis_" + date + "_total_" + typ + '_' + regionArgument + version + " -r " + typ + " -n 32 -t " + runTyp + " --channel2run " + str(channel) + " &> log_" + date + "_total_" + typ + '_' + regionArgument + version + ".txt&"
        print
